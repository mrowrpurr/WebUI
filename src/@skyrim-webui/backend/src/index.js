...
var webViewsHostClient = new WebViewsHostClient(function (script) { browser.executeJavaScript(script); });
on('browserMessage', function (message) {
...
export function getWebViewIds() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, getWebViewsHostClient().getWebViewIds()];
        });
    });
}
